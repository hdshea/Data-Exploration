...
```{r survival_rate_selected, include = TRUE, warning = FALSE, echo = FALSE, fig.asp = 1, fig.align = "default", out.width = "50%", fig.width = 4}
...
```{r survival_rate_income, include = TRUE, warning = FALSE, echo = FALSE, fig.asp = 1, fig.align = "default", out.width = "50%", fig.width = 4}
